...
export class AnnouncementDetailComponent implements OnInit {
   ...
   announcement:any
   isReacted!:boolean
   constructor(private annSer:AnnouncementService, private router:ActivatedRoute,private autuServ:AuthService){}
   ...
   ngOnInit(): void {
    this.annSer.getAnnouncementById(this.router.snapshot.paramMap.get('id') || '').subscribe({
      next:(data)=>{
        ...
        this.isReacted = this.autuServ.getRoles()?.includes('ROLE_USER') ? this.isReacted : true
